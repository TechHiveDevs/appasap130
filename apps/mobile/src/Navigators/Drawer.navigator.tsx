...
import ListTaskScreen from "../Entities/Task/List.task.screen";
import ShowTaskScreen from "../Entities/Task/Show.task.screen";
import ListOrganizationScreen from "../Entities/Organization/List.organization.screen";
import ShowOrganizationScreen from "../Entities/Organization/Show.organization.screen";
    ...
    <Stack.Navigator {...stackrops}>
      ...
      />
        ...
        <Stack.Screen
          ...
          <Stack.Screen
          name="ShowTaskScreen"
          component={ShowTaskScreen}
          options={screenOptions}
        />
        
        <Stack.Screen
            name="ListOrganizationScreen"
            component={ListOrganizationScreen}
            options={screenOptions}
          />
          <Stack.Screen
          name="ShowOrganizationScreen"
          component={ShowOrganizationScreen}
          options={screenOptions}
        />
